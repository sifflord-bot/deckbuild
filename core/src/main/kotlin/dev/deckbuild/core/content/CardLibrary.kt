...
object CardLibrary : CardResolver {
    ...
    private val flut: List<CardDef> = listOf(
        ...
        CardDef(
            ...
            subtypes = setOf(Subtype.GEIST),
            keywords = setOf(Keyword.FLUG),
            targets = listOf(zielGegnerKreatur.copy(optional = true)),
            onResolve = Effect.Antappen(Selector.Chosen(0)),
            rulesText = "Flug. Betritt das Schlachtfeld: Tappe eine gegnerische Kreatur.",
            flavor = "Die Welle kommt, bevor man sie hoert.",
        ),
        CardDef(
            id = "flut_bannwelle",
            name = "Bannwelle",
